...
\begin{table}[!h]
    ...
    \caption{Two Example Clinical Trial Report taken out of the Dataset to represent the two types Comparison and Single.
             Each Sample has a Statement, Label, the Relevant Section and one or two Premises.}
...
\begin{table}[!h]
    \centering
    \caption{Section and Label Distribution of the Dataset}
...
\begin{figure}[!htb]
    \hspace*{-4.5cm}
    \centering
    \includesvg[inkscapelatex=false, width=1.75\textwidth]{./content/histogram}
